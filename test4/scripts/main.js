...
const showInfo = () => {
    ...
    webButton.addEventListener('click', function (evt) {
      text.setAttribute("value", "reservation!");
      currentTab = 'web';
    });
    ...
    text.addEventListener('click', function (evt) {
      if (currentTab === 'web') {
        window.location.href="https://www.hatobus.co.jp/course/2024/whole-year/A7635?courseCategory=99&themeCode=448&page=&searchWords=&sortBy=2&recordCount=10";
      }
    });
  }
